...
if __name__ == "__main__":
    ...
    parser.add_argument('--source', type=str, default="amazon", help="The source dataset name")
    parser.add_argument('--target', type=str, default="webcam", help="The target dataset name")

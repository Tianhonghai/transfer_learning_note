...
def get_webcam(train):
    ...
    if train:
        dataset_source = datasets.ImageFolder(root='/data/office/domain_adaptation_images/webcam/images', transform=pre_process)
        webcam_data_loader = torch.utils.data.DataLoader(

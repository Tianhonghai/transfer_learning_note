...
def get_art(train):
    ...
    if train:
        ...
        dataset_source = datasets.ImageFolder(root='/data/office-home/images/Art', transform=pre_process)
        art_data_loader = torch.utils.data.DataLoader(

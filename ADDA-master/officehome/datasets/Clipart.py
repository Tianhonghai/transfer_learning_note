...
def get_clipart(train):
    ...
    if train:
        dataset_source = datasets.ImageFolder(root='/data/office-home/images/Clipart', transform=pre_process)
        clipart_data_loader = torch.utils.data.DataLoader(

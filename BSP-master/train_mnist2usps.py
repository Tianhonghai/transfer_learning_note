...
parser.add_argument('--src', type=str, default='mnist', metavar='S',
                    help='source dataset')
parser.add_argument('--tgt', type=str, default='usps', metavar='S',
                    help='target dataset')
...
def get_datasetname(args):
    ...
    mnist = '/data/mnist/mnist_train.txt'
    usps = '/data/usps/usps_train.txt'
    svhn = '/data/svhn/svhn_train.txt'
    if args.src == 'mnist':
        src = mnist
    elif args.src == 'usps':
        src = usps
    ...
    A = 'office-home/Art.txt'
    C = 'office-home/Clipart.txt'
    P = 'office-home/Product.txt'
    R = 'office-home/Real_World.txt'
    if args.src == 'A':
        src = A
    elif args.src == 'C':
        src = C
    ...
    a = 'office/amazon_list.txt'
    w = 'office/webcam_list.txt'
    d = 'office/dslr_list.txt'
    if args.src == 'a':
        src = a
        office = True
    elif args.src == 'w':
...
if visda == False:
    ...
    data_transforms = tran.transform_test(data_transforms=data_transforms, resize_size=28, crop_size=28)
...
def test_target(loader, model, test_iter=0):
    with torch.no_grad():
        ...
        if test_iter > 0:
            ...
            for i in range(1,50):
                print('it_test: {:5d} / {:5d}'.format(i, len(loader['val0'])))
...
if noe < 2:
    ...
    for iter_num in range(1, num_iter + 1):
        print('iter: {:05d} / {:05d}'.format(iter_num, num_iter))
        net.train(True)
        if office == False:

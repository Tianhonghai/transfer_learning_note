...
if __name__ == "__main__":
    ...
    parser.add_argument('--s_dset_path', type=str, default=osp.join(osp.dirname(__file__),'../data/office-home/Art.txt'), help="The source dataset path list")
    parser.add_argument('--t_dset_path', type=str, default=osp.join(osp.dirname(__file__),'../data/office-home/Clipart.txt'), help="The target dataset path list")

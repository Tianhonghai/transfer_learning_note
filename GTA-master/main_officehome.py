...
def main():
    ...
    transform_source = transforms.Compose([transforms.Resize([opt.imageSize,opt.imageSize]), transforms.ToTensor(), transforms.Normalize(mean,std)])
    transform_target = transforms.Compose([transforms.Resize([opt.imageSize,opt.imageSize]), transforms.ToTensor(), transforms.Normalize(mean,std)])
    ...
    source_train_list = 'office-home/Art.txt'
    source_val_list = 'office-home/Art.txt'
    target_train_list = 'office-home/Clipart.txt'

...
class GTA(object):
    ...
    def validate(self, epoch):
        ...
        for i, datas in enumerate(self.source_valloader):
            ...
            print('iter_test: {:5d} / {:5d}'.format(i, len(self.source_valloader)))
    ...
    def train(self):
        ...
        for epoch in range(self.opt.nepochs):
            ...
            for i, (datas, datat) in enumerate(zip(self.source_trainloader, self.targetloader)):
                ...
                print('iter_train: {:5d} / {:5d}'.format(i,min(len(self.source_trainloader),len(self.targetloader))))
            
            # Validate every epoch
            self.validate(epoch+1)
            print('epoch: {:5d} / {:5d}'.format(epoch, self.opt.nepochs))
